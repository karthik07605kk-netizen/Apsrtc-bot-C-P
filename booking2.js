...
(async () => {
  ...
  console.log("Starting APSRTC Automation: C-P");
...
// Wait until the boarding point dropdown is visible
await page.waitForSelector('#ForwardBoardId', { timeout: 10000 });

// Select the first actual boarding point (skips "Select One")
await page.selectOption('#ForwardBoardId', { index: 1 });

// Small delay so the page registers the selection
await page.waitForTimeout(1000);
